...
const VideoHighlight = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center lg:items-start bg-black text-white p-8">
      {/* Text Section */}
      <div className="lg:w-3/8 lg:pr-6 mb-6 lg:mb-0">
        <h3 className="text-sm uppercase text-gray-400 tracking-wide mb-2">Featured Video</h3>
      ...
      {/* Video Section */}
      <div className="lg:w-5/8 flex justify-center">
        <iframe
